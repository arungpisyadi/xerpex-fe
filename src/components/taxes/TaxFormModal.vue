<template>
  <div class="fixed inset-0 z-999 flex items-center justify-center bg-black bg-opacity-50">
    <div
      class="w-full max-w-lg rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:p-8"
    >
      ...
      <form @submit.prevent="handleSubmit" class="mb-6">
        ...
        <div class="flex justify-end gap-4 mt-6">
          ...
          <FormKit type="submit" :disabled="loading || !form.name || form.percentage === null">
