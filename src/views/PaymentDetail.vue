    ...
    <template v-else>
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            ...
            <span class="text-lg font-medium"
              >Payment #{{ payment.id }} - {{ capitalizeFirstLetter(payment.status) }}</span
            >
          </div>
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div class="md:col-span-1">
          ...
          >
            <h4 class="mb-6 text-xl font-semibold text-black dark:text-white">Payment Summary</h4>
            <div class="mb-4">
              ...
              <div class="mb-3 flex justify-between">
                ...
                <span class="text-sm font-medium text-black dark:text-white"
                  >IDR {{ formatPrice(payment.amount) }}</span
                >
              </div>
              <div class="mb-3 flex justify-between">
          ...
          >
            <h4 class="mb-6 text-xl font-semibold text-black dark:text-white">Payment Receipt</h4>
        ...
        <div class="md:col-span-2">
          ...
          >
            <div class="flex justify-between items-center mb-6">
              <h4 class="text-xl font-semibold text-black dark:text-white">Booking Information</h4>
              <router-link
            ...
            <div class="flex flex-col md:flex-row gap-4">
              ...
              <div class="md:w-2/3">
                ...
                <div>
                  ...
                  <span
                    class="text-sm font-medium px-2 py-1 rounded ml-2"
          ...
          <div
            class="rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark"
          >
            <h4 class="mb-6 text-xl font-semibold text-black dark:text-white">Payment Breakdown</h4>

            <div class="mb-6">
              <div class="mb-3 flex justify-between">
                <span class="text-sm text-gray-500 dark:text-gray-400"
                  >Base Rate ({{ getDuration(booking.check_in, booking.check_out) }} nights):</span
                >
                <span class="text-sm font-medium text-black dark:text-white"
                  >IDR {{ formatPrice(booking.base_amount) }}</span
                >
              </div>
              <div class="mb-3 flex justify-between">
                <span class="text-sm text-gray-500 dark:text-gray-400">Cleaning Fee:</span>
                <span class="text-sm font-medium text-black dark:text-white"
                  >IDR {{ formatPrice(booking.cleaning_fee) }}</span
                >
              </div>
              <div v-if="booking.additional_fees > 0" class="mb-3 flex justify-between">
                ...
                <span class="text-sm font-medium text-black dark:text-white"
                  >IDR {{ formatPrice(booking.additional_fees) }}</span
                >
              </div>
      ...
      <div
        class="mt-6 rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark"
      >
        <h4 class="mb-4 text-xl font-semibold text-black dark:text-white">Payment Notes</h4>
      ...
      <div
        class="mt-6 rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark"
      >
        <h4 class="mb-6 text-xl font-semibold text-black dark:text-white">Payment History</h4>
          ...
          <table class="w-full table-auto">
            <thead>
              <tr class="bg-gray-2 text-left dark:bg-meta-4">
                ...
                <th class="min-w-[100px] py-4 px-4 font-medium text-black dark:text-white">User</th>
              </tr>
            </thead>
            <tbody>
