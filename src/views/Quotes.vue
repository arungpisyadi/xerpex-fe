  ...
  <admin-layout>
    ...
    >
      <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 class="text-title-md2 font-bold text-black dark:text-white">Quotations Management</h2>
...
export default {
  ...
  setup() {
    const { quotes, loading, error, fetchQuotes, sendQuote, acceptQuote, convertQuoteToInvoice } =
      useInvoicing()
  ...
  methods: {
    ...
    showPermissionDeniedAlert(action) {
      ...
      alertDiv.className =
        'fixed top-4 right-4 z-50 p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 border border-red-300 dark:bg-gray-800 dark:text-red-400 dark:border-red-800'
      alertDiv.innerHTML = `
