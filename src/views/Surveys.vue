  ...
  <admin-layout>
    ...
    >
      <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 class="text-title-md2 font-bold text-black dark:text-white">Surveys Management</h2>
      ...
      >
        ...
        <template v-if="isViewMode">
          ...
          <div class="flex justify-end gap-4 mt-6">
            <button
              @click="closeModal"
              class="px-4 py-2 border border-stroke rounded text-black dark:text-white"
            >
              Cancel
            </button>
            <button
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="flex flex-col space-y-8">
                ...
                <FormKit
                  ...
                  name="salesmen_id"
                  label="Sales Account"
                  v-model="surveyForm.salesmen_id"
                  validation="required"
                  :options="[
...
export default {
  ...
  async created() {
    ...
    await Promise.all([this.fetchSurveys(), this.fetchSalesAccounts()])
  },
  methods: {
    async fetchSurveys() {
      try {
