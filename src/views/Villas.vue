<template>
  <admin-layout>
    ...
    <div class="mb-6">
      <page-breadcrumb page-title="Villas" />
    </div>
    ...
    >
      <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 class="text-title-md2 font-bold text-black dark:text-white">Villas Management</h2>
    ...
    >
      ...
      >
        ...
        <FormKit type="form" :actions="false" @submit="saveVilla" ref="villaFormRef">
          <div class="mb-4">
            <FormKit
              type="text"
              name="name"
          ...
          <div
            ...
            class="mb-4 rounded-md border-2 border-red-400 bg-red-50 p-4 dark:border-red-600 dark:bg-red-900/30"
          >
    ...
    >
      ...
      >
        <div class="mb-5 flex items-center justify-between">
          <h4 class="text-xl font-semibold text-black dark:text-white">Villa Details</h4>
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <p class="text-black dark:text-white">
                    {{
                      parseFloat(selectedVilla.base_price).toLocaleString(undefined, {
  ...
  methods: {
    async fetchVillas() {
      ...
      try {
        ...
        const errorMessage =
          error.response?.data?.message || error.message || 'Failed to fetch villas'
    ...
    async viewVilla(villa) {
      try {
        ...
        const errorMessage =
          error.response?.data?.message || error.message || 'Failed to fetch villa details'
        this.showNotification('error', errorMessage)
      } finally {
        this.loading = false
      }
    ...
    async saveVilla() {
      ...
      try {
        ...
        if (error.response?.data?.errors) {
          ...
          const errorMessage =
            error.response?.data?.message || error.message || 'Failed to save villa'
          this.showNotification('error', errorMessage)
        }
      } finally {
        this.loading = false
    ...
    async deleteVilla() {
      ...
      try {
        ...
        const errorMessage =
          error.response?.data?.message || error.message || 'Failed to delete villa'
        this.showNotification('error', errorMessage)
      } finally {
        this.loading = false
      }
